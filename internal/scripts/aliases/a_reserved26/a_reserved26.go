...
// arg1 - args (str)
// arg2 - blob (str)
func FrontendAgentReserved26(args ...object.Object) (object.Object, error) {
	...
	if err := BackendAgentReserved26(uint32(id.GetValue().(int64)), argsStr, blobBytes); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentReserved26(id uint32, args string, blob []byte) error {
	cap := shared.CapReserved26
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Reserved26{
			Reserved26: &commonv1.CapReserved26{
