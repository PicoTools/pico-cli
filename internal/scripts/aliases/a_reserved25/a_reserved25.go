...
// arg1 - args (str)
// arg2 - blob (str)
func FrontendAgentReserved25(args ...object.Object) (object.Object, error) {
	...
	if err := BackendAgentReserved25(uint32(id.GetValue().(int64)), argsStr, blobBytes); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentReserved25(id uint32, args string, blob []byte) error {
	cap := shared.CapReserved25
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Reserved25{
			Reserved25: &commonv1.CapReserved25{
