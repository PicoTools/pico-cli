...
// arg1 - args (str)
// arg2 - blob (str)
func FrontendAgentReserved30(args ...object.Object) (object.Object, error) {
	...
	if err := BackendAgentReserved30(uint32(id.GetValue().(int64)), argsStr, blobBytes); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentReserved30(id uint32, args string, blob []byte) error {
	cap := shared.CapReserved30
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Reserved30{
			Reserved30: &commonv1.CapReserved30{
