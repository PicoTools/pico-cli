...
func FrontendAntCd(args ...object.Object) (object.Object, error) {
	if len(args) != 2 {
	...
	if err := BackendAntCd(uint32(id.GetValue().(int64)), path.GetValue().(string)); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAntCd(id uint32, path string) error {
	cap := shared.CapCd
