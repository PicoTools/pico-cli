...
func FrontendAntJobkill(args ...object.Object) (object.Object, error) {
	if len(args) != 2 {
	...
	if err := BackendAntJobkill(uint32(id.GetValue().(int64)), jid.GetValue().(int64)); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAntJobkill(id uint32, jid int64) error {
