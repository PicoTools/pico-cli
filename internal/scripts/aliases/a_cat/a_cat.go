...
func FrontendAgentCat(args ...object.Object) (object.Object, error) {
	if len(args) != 2 {
	...
	if err := BackendAgentCat(uint32(id.GetValue().(int64)), path.GetValue().(string)); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentCat(id uint32, path string) error {
	cap := shared.CapCat
