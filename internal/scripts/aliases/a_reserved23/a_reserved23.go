...
// arg1 - args (str)
// arg2 - blob (str)
func FrontendAgentReserved23(args ...object.Object) (object.Object, error) {
	...
	if err := BackendAgentReserved23(uint32(id.GetValue().(int64)), argsStr, blobBytes); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentReserved23(id uint32, args string, blob []byte) error {
	cap := shared.CapReserved23
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Reserved23{
			Reserved23: &commonv1.CapReserved23{
