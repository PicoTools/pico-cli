...
func FrontendAgentExit(args ...object.Object) (object.Object, error) {
	if len(args) != 1 {
	...
	if err := BackendAgentExit(uint32(id.GetValue().(int64))); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentExit(id uint32) error {
	cap := shared.CapExit
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Exit{
