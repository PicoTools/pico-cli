...
func FrontendAntDownload(args ...object.Object) (object.Object, error) {
	if len(args) != 2 {
	...
	if err := BackendAntDownload(uint32(id.GetValue().(int64)), path.GetValue().(string)); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAntDownload(id uint32, path string) error {
