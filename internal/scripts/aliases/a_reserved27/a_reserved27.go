...
// arg1 - args (str)
// arg2 - blob (str)
func FrontendAgentReserved27(args ...object.Object) (object.Object, error) {
	...
	if err := BackendAgentReserved27(uint32(id.GetValue().(int64)), argsStr, blobBytes); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentReserved27(id uint32, args string, blob []byte) error {
	cap := shared.CapReserved27
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Reserved27{
			Reserved27: &commonv1.CapReserved27{
