...
func FrontendAgentJobs(args ...object.Object) (object.Object, error) {
	if len(args) != 1 {
	...
	if err := BackendAgentJobs(uint32(id.GetValue().(int64))); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentJobs(id uint32) error {
	cap := shared.CapJobs
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Jobs{
			Jobs: &commonv1.CapJobs{},
		},
	})
}
