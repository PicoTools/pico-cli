...
func FrontendAgentPs(args ...object.Object) (object.Object, error) {
	if len(args) != 1 {
	...
	if err := BackendAgentPs(uint32(id.GetValue().(int64))); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentPs(id uint32) error {
	cap := shared.CapPs
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Ps{
			Ps: &commonv1.CapPs{},
		},
	})
}
