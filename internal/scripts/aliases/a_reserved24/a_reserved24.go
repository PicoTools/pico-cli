...
// arg1 - args (str)
// arg2 - blob (str)
func FrontendAgentReserved24(args ...object.Object) (object.Object, error) {
	...
	if err := BackendAgentReserved24(uint32(id.GetValue().(int64)), argsStr, blobBytes); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAgentReserved24(id uint32, args string, blob []byte) error {
	cap := shared.CapReserved24
	...
	return service.NewTask(id, &operatorv1.CreateTaskRequest{
		Cap: uint32(cap),
		Args: &operatorv1.CreateTaskRequest_Reserved24{
			Reserved24: &commonv1.CapReserved24{
