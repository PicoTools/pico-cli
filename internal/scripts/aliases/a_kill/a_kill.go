...
func FrontendAntKill(args ...object.Object) (object.Object, error) {
	if len(args) != 2 {
	...
	if err := BackendAntKill(uint32(id.GetValue().(int64)), uint64(pid.GetValue().(int64))); err != nil {
		return nil, err
	}
	return object.NewNull(), nil
}

func BackendAntKill(id uint32, pid uint64) error {
	cap := shared.CapKill
